...
.AddJwtBearer("JwtBearer", options =>
{
    ...
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("health-clinic-chave-autenticacao-webapi-dev")),
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "API para gerenciamento de uma clinica de saúde - Backend API ",
